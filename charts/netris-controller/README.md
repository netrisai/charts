...
| `web-service-backend.image.tag`                                   | Image tag. Overrides the image tag whose default is the chart appVersion                                  | `"3.2.0-005"`                         |
...
| `web-service-frontend.image.tag`                                  | Image tag. Overrides the image tag whose default is the chart appVersion                                  | `"3.2.0-005"`                         |
...
| `grpc.image.tag`                       | Image tag. Overrides the image tag whose default is the chart appVersion                                  | `"3.2.0.002"`              |
...
| `migration.image.tag`            | Image tag. Overrides the image tag whose default is the chart appVersion      | `"3.2.0"`                                   |
