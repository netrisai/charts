...
| `web-service-backend.image.tag`                                   | Image tag. Overrides the image tag whose default is the chart appVersion                                  | `"3.3.0-002"`                         |
...
| `web-service-frontend.image.tag`                                  | Image tag. Overrides the image tag whose default is the chart appVersion                                  | `"3.3.0-002"`                         |
...
| `equinix-metal-agent.image.tag`                       | Image tag. Overrides the image tag whose default is the chart appVersion                                  | `"0.9.0"`                  |
...
| `migration.image.tag`            | Image tag. Overrides the image tag whose default is the chart appVersion      | `"3.2.1"`                                   |
