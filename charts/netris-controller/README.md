...
| `web-service-backend.image.tag`                                   | Image tag. Overrides the image tag whose default is the chart appVersion                                  | `"3.5.0-019"`                         |
...
| `web-service-frontend.image.tag`                                  | Image tag. Overrides the image tag whose default is the chart appVersion                                  | `"3.5.0-013"`                         |
...
| `migration.image.tag`            | Image tag. Overrides the image tag whose default is the chart appVersion      | `"3.5.0"`                                 |
